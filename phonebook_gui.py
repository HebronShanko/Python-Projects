...
def load_gui(self):
    ...
    self.lbl_fname = tk.Lable(self.master,text='First Name:')
    self.lbl_fname.grid(row=0,column=0,padx=(27,0),pady=(10,0),sticky=N+W)
    self.lbl_lname = tk.Lable(self.master,text='Last Name:')
    self.lbl_lname.grid(row=0,column=0,padx=(27,0),pady=(10,0),sticky=N+W)
    self.lbl_phone = tk.Lable(self.master,text='Phone Number:')
    self.lbl_phone.grid(row=0,column=0,padx=(27,0),pady=(10,0),sticky=N+W)
    self.lbl_email = tk.Lable(self.master,text='Email Adress:')
    self.lbl_email.grid(row=0,column=0,padx=(27,0),pady=(10,0),sticky=N+W)
    self.lbl_user = tk.Lable(self.master,text='User:')
    ...
    self.lstList.bind('<<ListboxSelect>>', lambda event: phonebook_func.onSelect(self,event))
    ...
    self.lstList.grid(row=1,column=2,rowspan=7,columnspan=3,padx=(0,0),pady=(0,0),sticky=N+E+W)
